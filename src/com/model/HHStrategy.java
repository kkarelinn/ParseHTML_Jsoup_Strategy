...
public class HHStrategy implements Strategy {
    ...
    public List<Vacancy> getVacancies(String searchString) {
        ...
        try {
            do {
                ...
                Elements vacanciesHtmlList = doc.getElementsByAttributeValue("data-qa", "vacancy-serp__vacancy vacancy-serp__vacancy_standard_plus");
                ...
                for (Element element : vacanciesHtmlList) {
                    ...
                    vacancy.setSalary(!salary.isEmpty() ? salary.get(0).text() : "");
    ...
    protected Document getDocument(String searchString, int page) throws IOException {
        Document doc = null;
        while(true){
          try{doc = Jsoup.connect(String.format(URL_FORMAT, searchString, page))
